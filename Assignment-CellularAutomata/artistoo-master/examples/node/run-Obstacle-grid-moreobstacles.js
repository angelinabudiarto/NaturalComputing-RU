...
let config = {
    ...
    simsettings: {
        ...
        SAVEIMG : true,
        IMGFRAMERATE: 1,
        SAVEPATH : "output/img/Obstacle-grid-moreobstacles",    // ... And save the image in this folder.
        EXPNAME : "Obstacle-grid-moreobstacles",                    // Used for the filename of output images.
